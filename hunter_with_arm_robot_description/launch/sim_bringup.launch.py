...
def generate_launch_description():
    ...
    Uses empty_world.world from hunter_with_arm_robot_description package.

    This launch file depends on hunter_with_arm_robot_bringup package for MoveIt
    ...
    pkg_dir = get_package_share_directory("hunter_with_arm_robot_description")
    ...
    # World file from hunter_with_arm_robot_description package
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("hunter_with_arm_robot_description"),
                    "description",
    ...
    # Build MoveIt config (from hunter_with_arm_robot_bringup package)
    # This provides SRDF, trajectory execution, kinematics, and planning pipelines
    moveit_config = (
        MoveItConfigsBuilder(
            "mobile_manipulator", package_name="hunter_with_arm_robot_bringup"
        )
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("hunter_with_arm_robot_bringup"),
        "config",
        "moveit.rviz",
    )
